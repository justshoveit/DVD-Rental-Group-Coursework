...
namespace SAMS.Controllers
{
    ...
    public class StudentReportController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            List<SelectListItem>  CourseDDL = courses.Select(x => new SelectListItem
            {
                Text = x.Name,
                Value = x.Id.ToString()
            }).ToList();
            CourseDDL.Insert(0, new SelectListItem { Text = "All Courses", Value = "-1" });
            ViewBag.CourseDDL = CourseDDL;
            return View();
        }
